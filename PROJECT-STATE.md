...
- [ ] **Deploy Shiprocket Edge Function** — `supabase/functions/create-shiprocket-order/index.ts` scaffold added locally. Needs Supabase CLI or dashboard deployment plus secrets: `SHIPROCKET_EMAIL`, `SHIPROCKET_PASSWORD`, `SHIPROCKET_PICKUP_LOCATION`, and `SERVICE_ROLE_KEY`.
